...
<html>
<head>
	<title>New Manager Registration | Manager</title>
	<link rel="stylesheet" href="../assets/css/StyleSheet2.css">
</head>
	<div class="contain">
		<form method="post" action="../controller/ManagerRegCheck.php" enctype="multipart/form-data" onsubmit = "return CheckPass()">
